...
export default function Sidebar() {
    ...
    return (
        <aside className="sidebar fixed top-0 bottom-0 lg:left-0 p-2 lg:w-[300px] md:w-[200px] w-[150px] overflow-y-auto text-center bg-gray-900">
            ...
            <div className="my-2 bg-gray-600 h-[1px]"></div>
            <button onClick={() => {setLoggedInUser('');router.push('/');}} className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
